export const MEALS = [
  ...
  // MyDiabetes.health — Type 1, Type 2, Prediabetes meal plans
  {
    name: "Apple-Cinnamon Overnight Oats",
    category: "Breakfast",
    calories: 310,
    prep: 5,
    description: "No-cook overnight oats with chia, diced apple, and cinnamon — a prediabetes plate-method breakfast with 6g fibre and sustained glucose release.",
    tags: ["prediabetes", "no-cook", "meal prep", "high fibre"],
    cuisine: "American",
    ethnicity: "Western",
    image: "https://images.unsplash.com/photo-1571748982800-fa51082c2224?w=800&q=80",
    glycemic: "Low",
    giScore: 40,
    source: "https://mydiabetes.health",
    ingredients: ["½ cup rolled oats", "¼ cup unsweetened almond milk", "1 tbsp chia seeds", "1 small apple, diced", "½ tsp cinnamon", "1 tsp honey or sugar-free sweetener (optional)", "Pinch of nutmeg"],
    steps: [
      "Combine rolled oats, chia seeds, almond milk, and cinnamon in a jar or bowl.",
      "Stir well to distribute chia seeds evenly.",
      "Fold in diced apple. Add honey or sweetener if desired.",
      "Cover and refrigerate overnight (minimum 6 hours).",
      "In the morning, stir and add a splash more almond milk if too thick.",
      "Eat cold or warm in the microwave for 60–90 seconds."
    ],
    diabetesTip: "Rolled oats release glucose slowly due to their beta-glucan fibre content. Chia seeds add soluble fibre that forms a gel, further flattening the glucose curve. Cinnamon actively lowers post-meal blood sugar spikes."
  },
  {
    ...
    calories: 280,
    prep: 5,
    description: "Plain Greek yogurt layered with mixed berries, walnuts, and a touch of honey — a Type 2 diabetes plate-method breakfast with 12g protein.",
    tags: ["high protein", "probiotic", "quick", "type 2"],
    cuisine: "Mediterranean",
    ethnicity: "Mediterranean",
    ...
    giScore: 32,
    source: "https://mydiabetes.health",
    ingredients: ["¾ cup plain Greek yogurt (0% fat)", "½ cup mixed berries (blueberries, strawberries, raspberries)", "2 tbsp walnuts, roughly chopped", "1 tsp honey", "½ tsp vanilla extract", "Pinch of cinnamon"],
    steps: [
    ...
    diabetesTip: "Plain Greek yogurt contains probiotics that reduce gut-derived inflammation — a key driver of insulin resistance. Berries are among the lowest-GI fruits and loaded with anthocyanins that improve insulin sensitivity."
  },
  {
    ...
    calories: 350,
    prep: 30,
    description: "Hearty steel-cut oats with anti-inflammatory walnuts and antioxidant-rich blueberries — the MyDiabetes Type 1 breakfast with 45g precisely counted carbs.",
    tags: ["type 1", "carb counting", "anti-inflammatory", "slow release"],
    cuisine: "American",
    ethnicity: "Western",
    ...
    giScore: 42,
    source: "https://mydiabetes.health",
    ingredients: ["½ cup steel-cut oats", "2 cups water", "¼ cup walnut halves", "½ cup fresh blueberries", "½ tsp cinnamon", "Pinch of salt"],
    steps: [
      "Bring water and a pinch of salt to a boil in a saucepan.",
      "Stir in steel-cut oats. Reduce to a gentle simmer.",
      "Cook uncovered 25–30 minutes, stirring occasionally, until creamy.",
      "Remove from heat. Stir in cinnamon.",
      "Spoon into a bowl. Top with walnut halves and fresh blueberries.",
      "For Type 1: this bowl is approximately 45g carbs — dose 10–15 minutes before eating."
    ],
    diabetesTip: "Steel-cut oats have a GI of ~42 vs ~66 for quick oats. Walnuts' ALA omega-3s reduce inflammation. Blueberries' anthocyanins improve insulin signalling. Cinnamon may lower post-meal glucose by up to 29%."
  },
  {
    ...
    calories: 420,
    prep: 15,
    description: "A Type 1-friendly quinoa and chickpea salad with arugula, cherry tomatoes, and feta — 45g carbs, 8g fibre, precisely portioned for insulin dosing.",
    tags: ["type 1", "carb counting", "high fibre", "plant protein"],
    cuisine: "Mediterranean",
    ethnicity: "Mediterranean",
    ...
    giScore: 48,
    source: "https://mydiabetes.health",
    ingredients: ["½ cup cooked quinoa", "¼ cup canned chickpeas, drained", "2 cups arugula", "½ cup cherry tomatoes, halved", "¼ cup crumbled feta cheese", "2 tbsp extra-virgin olive oil", "Juice of 1 lemon", "Salt, pepper, dried oregano"],
    steps: [
      "Cook quinoa per packet instructions and cool to room temperature.",
      "Whisk olive oil, lemon juice, oregano, salt, and pepper into a dressing.",
      "Combine quinoa, chickpeas, arugula, and cherry tomatoes in a large bowl.",
      "Pour dressing over and toss well.",
      "Top with crumbled feta.",
      "Serve immediately. For Type 1: this bowl is approximately 45g carbs — dose accordingly."
    ],
    diabetesTip: "Quinoa is a complete protein grain with a GI of 53. Chickpeas drop that blended GI significantly. For Type 1 users: 1 cup cooked chickpeas = ~45g carbs — use this for accurate bolus calculations."
  },
  {
    ...
    calories: 340,
    prep: 10,
    description: "A vibrant prediabetes plate-method salad with mixed greens, chickpeas, quinoa, cucumber, and tomatoes — 9g fibre, 12g protein, average GI under 40.",
    tags: ["prediabetes", "high fibre", "plant-based", "quick"],
    cuisine: "International",
    ethnicity: "Western",
    image: "https://images.unsplash.com/photo-1540420773420-3366772f4999?w=800&q=80",
    glycemic: "Low",
    giScore: 38,
    source: "https://mydiabetes.health",
    ingredients: ["3 cups mixed salad greens", "½ cup canned chickpeas, drained", "¼ cup cooked quinoa", "½ cucumber, diced", "½ cup cherry tomatoes, halved", "1 carrot, grated", "1 tbsp extra-virgin olive oil", "1 tbsp apple cider vinegar", "Salt and pepper"],
    steps: [
      "Whisk olive oil, apple cider vinegar, salt, and pepper into a dressing.",
      "Arrange mixed greens as the base in a large bowl.",
      "Add chickpeas, quinoa, cucumber, cherry tomatoes, and grated carrot.",
      "Drizzle dressing over everything.",
      "Toss gently to combine.",
      "Eat immediately. The colours indicate different antioxidants — aim for as many as possible."
    ],
    diabetesTip: "Apple cider vinegar in the dressing reduces the glycaemic index of the entire meal by slowing gastric emptying. This bowl follows the prediabetes plate method: 50% non-starchy veg, 30% protein, 20% high-fibre carbs."
  },
  {
    ...
    calories: 445,
    prep: 20,
    description: "Whole-grain farro with omega-3-rich sardines, mixed greens, and olive-lemon dressing — a Type 2 Mediterranean-plan lunch with 28g protein.",
    tags: ["omega-3", "type 2", "Mediterranean", "whole grain"],
    cuisine: "Mediterranean",
    ethnicity: "Mediterranean",
    image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&q=80",
    glycemic: "Low-Medium",
    giScore: 45,
    source: "https://mydiabetes.health",
    ingredients: ["½ cup cooked farro", "1 can sardines in olive oil, drained", "2 cups mixed greens", "½ cup cherry tomatoes, halved", "1 tbsp extra-virgin olive oil", "Juice of 1 lemon", "Salt, pepper, capers (optional)"],
    steps: [
      "Cook farro per packet instructions. Cool slightly.",
      "Whisk olive oil, lemon juice, salt, and pepper into a dressing.",
      "Arrange mixed greens in a bowl. Top with farro and cherry tomatoes.",
      "Flake sardines over the bowl.",
      "Drizzle with dressing. Add capers if desired.",
      "Toss gently and serve. Prep farro in advance for a 5-minute assembly."
    ],
    diabetesTip: "Farro is a high-fibre ancient grain with a GI of ~40 — significantly lower than white rice. Sardines provide more omega-3s per gram than salmon and are sustainably sourced. This bowl is clinically shown to lower HbA1c."
  },
  {
    ...
    calories: 420,
    prep: 40,
    description: "Herb-roasted chicken thighs with zucchini, eggplant, and bell pepper over quinoa — the ADA Mediterranean-style Type 2 dinner with 30g protein.",
    tags: ["type 2", "Mediterranean", "meal prep", "high protein"],
    cuisine: "Mediterranean",
    ethnicity: "Mediterranean",
    ...
    giScore: 28,
    source: "https://mydiabetes.health",
    ingredients: ["4 skinless chicken thighs (150g each)", "1 zucchini, diced", "1 eggplant, diced", "2 bell peppers, diced", "¼ cup cooked quinoa per serving", "3 tbsp extra-virgin olive oil", "2 tsp dried oregano", "2 garlic cloves, minced", "Juice of 1 lemon", "Salt and pepper"],
    steps: [
      "Preheat oven to 200°C (400°F).",
      "Toss zucchini, eggplant, and bell peppers with 2 tbsp olive oil, oregano, salt, and pepper. Spread on a baking tray.",
      "Rub chicken thighs with remaining olive oil, garlic, lemon juice, salt, and pepper.",
      "Nestle chicken on top of vegetables.",
      "Roast 35–40 minutes until chicken is golden and cooked through (75°C/165°F internal).",
      "Serve over a small portion of quinoa. Drizzle any pan juices over the top."
    ],
    diabetesTip: "Skin-off chicken thighs reduce saturated fat while keeping the meat juicy. Non-starchy roasted vegetables (zucchini, eggplant, peppers) have virtually no glycaemic impact and are loaded with antioxidants."
  },
  // Riverside Community Hospital — prediabetes/diabetes
  {
  ...
  // Taste of Home — diabetic-friendly dinners
  {
  ...
  // Mayo Clinic diabetes meal plan
  {
